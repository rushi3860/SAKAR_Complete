...
<?php session_start();
?>
<h1 class="subheading">Upload Admission Files</h1>
<div class="upload">
  ...
  ?>
    <div id="upload">
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <button type="submit" class="btn btn-success" name="upload"><i class="fa fa-upload"></i> Upload Admission File</button>
        </form>
    </div>
</div>
...
move_uploaded_file($file_tmp,"doc/".$pname."/Admission/".$_POST['pname'].".pdf");
echo "Success";
}else{
print_r($errors);
}
