...
<head>
    ...
    <meta charset="UTF-8">
    <title>Upload Adoption Files</title>
</head>
<body>
<!--Main Header-->
<div class="header">
...
<?php   session_start();
      ?>
<!--Upload adoption Files-->
<h1 class="subheading">Upload Adoption Files</h1>
<div class="upload">

    <form method="post">
        <input type="text" name="child"placeholder="Enter Child Id">
        <button type="submit" name="key" class="btn btn-warning"><i class="fa fa-search"></i></button>
    </form>
  ...
  ?>
    <form action="" method="POST" enctype="multipart/form-data">
                ...
                <button type="submit" name="upload" class="btn btn-success"><i class="fa fa-upload"></i> Upload Adoption File</button>
            </form>
</div>
